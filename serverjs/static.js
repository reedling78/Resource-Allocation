...
exports.klt = function () {
	...
	return {
		Employees : [
			{name:'Kevin Mech',             id:1, teamid:1, jobid:1},
			{name:'Tammie Babbitt',         id:2, teamid:1, jobid:2},
			{name:'Elizabeth Karagitlieva', id:3, teamid:1, jobid:1},
			{name:'David Mansch',           id:4, teamid:1, jobid:1},
			
			{name:'Michael Shuck',          id:5, teamid:4, jobid:2},
			{name:'Mike Biasi',             id:6, teamid:4, jobid:1},
			...
			{name:'Eric Figura',            id:17, teamid:3, jobid:2},
			{name:'Brian Layman',           id:18, teamid:3, jobid:2},
			
			{name:'Brian Pautsch',          id:19, teamid:2, jobid:2},
